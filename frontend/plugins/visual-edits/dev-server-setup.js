      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="support@maplin.co" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="support@maplin.co" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
